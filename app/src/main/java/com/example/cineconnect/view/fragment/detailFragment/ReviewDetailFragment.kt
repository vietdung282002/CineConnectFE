...
import com.example.cineconnect.view.adapter.CommentPagingAdapter
import com.example.cineconnect.view.fragment.bottomSheet.EditCommentFragment
import com.example.cineconnect.view.fragment.bottomSheet.ReviewOptionFragment
import com.example.cineconnect.view.onClickInterface.DeleteReviewListener
import com.example.cineconnect.view.onClickInterface.OptionsMenuClickListener
    ...
    private fun updateUI(review: Review) {
        ...
        fragmentReviewDetailBinding.apply {
            ...
            llUser.setOnClickListener {
                val bundle = Bundle()
                bundle.putInt(Utils.USER_ID, review.user.id)
